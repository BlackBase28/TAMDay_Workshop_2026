...
The Forwarder also publishes `cve_radar_collector_hostname` (default: `inventory_hostname`) so AI Analysis uses the inventory/MCP host key instead of a cloud provider internal OS hostname.
